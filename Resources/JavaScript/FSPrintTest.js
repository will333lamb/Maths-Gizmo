...
function trainTimetable(){
    ...
    <span class="questionNumber">Q15.</span>
    ...
    <br>
    <span class="questionNumber">a)</span> Work out the best train for ${name} to catch.<br><br>
    <br><br><br><br><br><br><br><br>
    <p id="marksGiven">(4 marks)</p><br><br>
    ...
    <table id="trainTicketPricesTable">
        ...
        <tr>
            <td style="text-align:left;"><span class="bold">Ticket type</span></td>
            <td><span class="bold">Off-peak (weekends)</span></td>
            <td><span class="bold">Peak (any day)</span></td>
        </tr>
        <tr>
            <td style="text-align:left;"><span class="bold">Single (one way)</span></td>
            <td> £${singleOffPeak} </td>
            <td> £${singlePeak} </td>
        </tr>
        <tr>
            <td style="text-align:left;"><span class="bold">Return (two journeys)</span></td>
            <td> £${returnOffPeak} </td>
            <td> £${returnPeak} </td>
        </tr>
    </table>
    <br>
    <span class="questionNumber">b)</span> ${name} will travel back on Monday. Work out the cheapest cost for ${himOrHer} to travel to London and back.<br><br><br><br><br><br><br><br><br>
    <p id="marksGiven">(2 marks)</p><br><br>
    ${pagebreak}
    <p id="marksGiven" style="font-weight: bold; font-style: normal;">Total marks: 45</p><br><br><br>
    <div class="frontPage">
    End of Calculator paper
    </div>
    `
    ...
    solutionText.innerHTML += 
    `
    <span class="questionNumber">Q15.</span><br><br>
    <span class="questionNumber">a)</span> As it is a 15 minute walk from the station in London, the train needs to arrive in London 15 minutes before ${meetingStartTime}.<br>
    ...
    <br>
    <span class="questionNumber">b)</span> If ${name} was to buy two single tickets, since ${name} is travelling out on a Sunday and returning on a Monday. ${heOrShe} will need to buy an off peak single
